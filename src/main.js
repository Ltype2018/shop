...
.use(SubmitBar).use(NavBar).use(List).use(Skeleton).use(Divider).use(Stepper).use(GoodsAction).use(GoodsActionButton).use(GoodsActionIcon).use(Sku).use(Sidebar).use(SidebarItem)
